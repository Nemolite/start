...
{
	wp_enqueue_style('start-bootstrapmin', get_template_directory_uri() . '/assets/node_modules/bootstrap/dist/css/bootstrap.min.css', array(), _S_VERSION);
	wp_enqueue_style('start-bootstraptheme', get_template_directory_uri() . '/assets/node_modules/bootstrap/dist/css/bootstrap-theme.min.css', array(), _S_VERSION);
	wp_enqueue_style('start-bootstrapicons', get_template_directory_uri() . '/assets/bootstrap-icons-1.10.3/bootstrap-icons.css', array(), _S_VERSION);

	wp_enqueue_style('start-style', get_stylesheet_uri(), array(), _S_VERSION);
	wp_style_add_data('start-style', 'rtl', 'replace');
	wp_enqueue_style('start-maincss', get_template_directory_uri() . '/assets/css/main.css', array(), _S_VERSION);

	wp_enqueue_script('start-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), _S_VERSION, true);

	wp_enqueue_script('start-jquerymin', get_template_directory_uri() . '/assets/node_modules/jquery/dist/jquery.min.js', array(), _S_VERSION, true);
	wp_enqueue_script('start-bootstrapminjs', get_template_directory_uri() . '/assets/node_modules/bootstrap/dist/js/bootstrap.min.js', array(), _S_VERSION, true);
	wp_enqueue_script('start-mainjs', get_template_directory_uri() . '/assets/js/main.js', array(), _S_VERSION, true);
